...
export const ControlsMixin = (ModelViewerElement) => {
    ...
    class ControlsModelViewerElement extends ModelViewerElement {
        ...
        [(_a = $fov, _b = $idealCameraDistance, _c = $idleTime, _d = $userPromptedOnce, _e = $waitingToPromptUser, _f = $shouldPromptUserToInteract, _g = $lastSpherical, _h = $changeHandler, _j = $focusHandler, _k = $blurHandler, _l = $promptTransitionendHandler, $updateCameraOrbit)]() {
